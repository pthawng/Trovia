          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs text-muted-foreground">{t("explore.placeholder")}</p>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[11px] text-muted-foreground">{t("property.verified_landlord")}</p>
              </div>
            </div>
          </motion.div>
